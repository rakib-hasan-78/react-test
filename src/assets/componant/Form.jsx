...
const Form = () => {
    ...
    const formHandler = (e) => {
        ...
        setForm({firstName:"ryan", lastName: "doe", email:"xample@example.com", phone:"+12345678", city:"kushtia", gender:"male"})
    }
                ...
                <form onSubmit={formHandler} action="#">
                    <div className='w-full flex justify-center items-center space-x-0'>
                        ...
                        <input value={form.firstName}
                         onChange={(e)=> {dataHandler('firstName', e.target.value)}}
                        ...
                        <input value={form.lastName}
                         onChange={(e) => {dataHandler("lastName", e.target.value)}}
                        className='bg-orange-300 border-0 outline-none py-1 px-3 rounded-md text-orange-100 font-medium' 
                    ...
                    <div className='w-full flex  items-center justify-center space-x-8 my-3'>
                        ...
                        <input value={form.phone}
                         onChange={(e) => {dataHandler("phone", e.target.value)}}
                        className='bg-orange-300 border-0 outline-none py-1 px-3 rounded-md text-orange-100 font-medium w-9/12' 
                    ...
                    <div className='w-full flex  items-center justify-center space-x-8 my-3'>
                        ...
                        <select
                        value={form.city}
                         onChange={(e) => {dataHandler("city", e.target.value)}}
                        className='bg-orange-300 border-0 outline-none py-1 px-3 rounded-md text-orange-100 font-medium w-9/12' 
                    ...
                    <div className='w-full flex  items-center justify-center space-x-8 my-3'>
                        ...
                        onChange={() => {dataHandler("gender", "eunuch")}}
                          type="radio" name="male" id="eunuch" /> <span className='text-orange-100 capitalize font-extrabold italic'>eunuch</span>
                    </div>
